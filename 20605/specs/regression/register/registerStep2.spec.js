...
describe('REGISTER PAGE STEP 2', function () {
  ...
  describe('ELEMENTS ARE DISPLAYED', function () {
    ...
    it('TC-086 Phone field placeholder has correct text', function () {
      expect(RegisterStep2Page.phoneNumber.getAttribute('placeholder')).eq(registerPageTestResult.phoneNumberPlaceholder);
    });
    ...
    it('TC-085 Phone label has correct text', function () {
      expect(RegisterStep2Page.phoneLabel.getText()).eq(registerPageTestResult.phoneLabel);
    });
    ...
    it('TC-081 Country label has correct text', function () {
      expect(RegisterStep2Page.countryLabel.getText()).eq(registerPageTestResult.countryLabel);
    });
